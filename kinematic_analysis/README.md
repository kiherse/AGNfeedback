...
Last but not least, the results from the different outflow detection methods are presented and compare. All results (and figures) are saved in other folders in order to simplify the later comparisson and search for correlations between the data.
